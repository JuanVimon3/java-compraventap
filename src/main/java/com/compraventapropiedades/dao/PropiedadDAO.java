...
public class PropiedadDAO {
    ...
    public void insertarPropiedad(Propiedad propiedad) {
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            transaction.commit();
            System.out.println("Propiedad registrada con Hibernate");
        } catch (Exception e) {
    ...
    public void eliminarPropiedad(int idPropiedad) {
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            transaction = session.beginTransaction();
            Propiedad prop = session.get(Propiedad.class, idPropiedad);
            if (prop != null) {
                session.remove(prop);
            }
            transaction.commit();
...
//Lógica de PropiedadDAO en JDBC
